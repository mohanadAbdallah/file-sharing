...
{{--                    <img src="{{ url('storage/uploads/'.$file->file) }}">--}}

                    <h5 class="text-left mb-4 ">File Link To share </h5>
                        <div class="copy-box border rounded p-3 d-flex justify-content-between align-items-center ">
...
<script>
    function copyText() {
        ...
        copyButton.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check-fill" viewBox="0 0 16 16">
  <path d="M10 .5a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5.5.5 0 0 1-.5.5.5.5 0 0 0-.5.5V2a.5.5 0 0 0 .5.5h5A.5.5 0 0 0 11 2v-.5a.5.5 0 0 0-.5-.5.5.5 0 0 1-.5-.5Z"/>
